...
/**
 * 这个是终端页带上一页下一页的.所以要传递srverList 项目名称：app43 类名称：BaseOnClickListItemAdapter1 类描述：
 * 创建人：APP43 创建时间：2012-2-19 下午2:02:04 修改人：APP43 修改时间：2012-2-19 下午2:02:04 修改备注：
 * 
 * @version
 * 
 */
public abstract class BaseOnClickListItemAdapter1 extends BaseAdapter {
    protected String TAG;
    public Activity activity;
    public int appcount = 0;

    public BaseOnClickListItemAdapter1(Activity activitys, String tag) {
        TAG = tag;
        activity = activitys;
